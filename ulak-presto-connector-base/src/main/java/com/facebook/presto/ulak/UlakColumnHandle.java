        ...
        implements ColumnHandle
{
    ...
    @JsonCreator
    public UlakColumnHandle(@JsonProperty("connectorId") String connectorId, @JsonProperty("columnName") String columnName, @JsonProperty("columnType") Type columnType, @JsonProperty("ordinalPosition") int ordinalPosition)
    {
    ...
    public boolean equals(Object obj)
    {
        ...
        UlakColumnHandle other = (UlakColumnHandle) obj;
