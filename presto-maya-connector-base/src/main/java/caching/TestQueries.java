...
public class TestQueries {
    ...
    public static final String SAMPLE_QUERY_WITH_CACHE= "//" + InfluxdbQueryParameters.TEXT_CACHE + "=true\n"
            +"//" +  InfluxdbQueryParameters.TEXT_TTL + "=60\n"
            +"//" +  InfluxdbQueryParameters.TEXT_REFRESH + "=10\n"
            + SAMPLE_QUERY;
    ...
    public static final String SAMPLE_QUERY_2_WITH_CACHE= "//" + InfluxdbQueryParameters.TEXT_CACHE + "=true\n"
            + "//" + InfluxdbQueryParameters.TEXT_TTL + "=60\n"
            + "//" + InfluxdbQueryParameters.TEXT_REFRESH + "=10\n"
            + SAMPLE_QUERY_2;
    ...
    public static final String SAMPLE_QUERY_3_WITH_CACHE= "//" + InfluxdbQueryParameters.TEXT_CACHE + "=true\n"
            + "//" + InfluxdbQueryParameters.TEXT_TTL + "=60\n"
            + "//" + InfluxdbQueryParameters.TEXT_REFRESH + "=10\n"
            + SAMPLE_QUERY_3;
    ...
    public static final String SAMPLE_QUERY_4_WITH_CACHE= "//" + InfluxdbQueryParameters.TEXT_CACHE + "=true\n"
            + "//" + InfluxdbQueryParameters.TEXT_TTL + "=60\n"
            + "//" + InfluxdbQueryParameters.TEXT_REFRESH + "=10\n"
            + SAMPLE_QUERY_4;
    ...
    public static final String SAMPLE_QUERY_5_WITH_CACHE= "//" + InfluxdbQueryParameters.TEXT_CACHE + "=true\n"
            + "//" + InfluxdbQueryParameters.TEXT_TTL + "=60\n"
            + "//" + InfluxdbQueryParameters.TEXT_REFRESH + "=10\n"
            + SAMPLE_QUERY_5;
    ...
    public static final String SAMPLE_QUERY_6_WITH_CACHE=
            "--" + InfluxdbQueryParameters.TEXT_CACHE + "=true\n"
            + "--" + InfluxdbQueryParameters.TEXT_TTL + "=60\n"
            + "--" + InfluxdbQueryParameters.TEXT_REFRESH + "=10\n"
            //+ "--"+ TEXT_CACHE + "=true\n" +
            + "--" + InfluxdbQueryParameters.TEXT_DBTYPE + "=pg\n"
    ...
    public static final String SAMPLE_QUERY_7_WITH_CACHE=
                    "//" + InfluxdbQueryParameters.TEXT_TTL + "=172800\n" +
                    "//" + InfluxdbQueryParameters.TEXT_REFRESH + "=10\n" +
                    "//"+ InfluxdbQueryParameters.TEXT_CACHE+"=false\n" +
                    "//eagercache=false\n" +
                    "//name=Hub Network Throughput (bps)\n" +
                    "//columns=/3/buckets/1/key,/3/buckets/1/value,/3/buckets/4/value\n" +
                    "//" + InfluxdbQueryParameters.TEXT_DBTYPE + "=qw\n" +
                    SAMPLE_QUERY_7;
