...
public class UlakQuickwitMetadata
    ...
    public ConnectorTableHandle getTableHandle(ConnectorSession session, SchemaTableName tableName, Optional<ConnectorTableVersion> startVersion, Optional<ConnectorTableVersion> endVersion) {
        // The Grafana Trino plugin base32-encodes query-in-table-name strings to survive
        // Trino's identifier case-normalization. Decode here so isPlainMode() and
        // QueryParameters.getQueryParameters() downstream see the original query text.
        // See PlainTableQuery.decodeIfBase32Encoded() and QW9-03 in CHANGELOG.md.
        String rawName = PlainTableQuery.decodeIfBase32Encoded(tableName.getTableName());
