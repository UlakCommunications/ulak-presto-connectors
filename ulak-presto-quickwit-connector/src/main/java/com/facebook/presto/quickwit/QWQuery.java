...
public class QWQuery
    ...
    public static final String NAME = "quickwit_query";

    @Override
    public ConnectorTableFunction get() {
        return new ClassLoaderSafeConnectorTableFunction(new QWQueryFunction(), getClass().getClassLoader());
    }

    public static class QWQueryFunction
            extends AbstractConnectorTableFunction {
        private static final String TABLE_ARGUMENT_NAME = "INPUT";
        private static final String DESCRIPTOR_ARGUMENT_NAME = "COLUMNS";

        public QWQueryFunction() {
            super(
                    "BUILTIN_SCHEMA",
                    NAME,
                    ImmutableList.of(
        ...
        public TableFunctionAnalysis analyze(
            ...
            return TableFunctionAnalysis.builder()
                    ...
                    .handle(new QWQueryFunctionHandle())
                    .build();
        }
    }

    public static TableFunctionProcessorProvider getQWQueryFunctionProcessorProvider() {
    ...
    public record QWQueryFunctionHandle()
